...
- runNewExperiment - Full workflow of creating, naming, and starting a run under a new experiment, logging mettrics, params,tags, and the model, and finishing the run
